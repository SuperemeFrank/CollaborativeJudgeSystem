...
IMAGE_NAME = "frankyu/cjs_demo_2"

CURREMT_DIR = os.path.dirname(os.path.realpath(__file__))

TEMP_BUILD_DIR = "%s/tmp/" % CURREMT_DIR
...
def build_and_run(code, lang):
    ...
    source_file_parent_dir_name = uuid.uuid4() # randomly generate unique unicode value
